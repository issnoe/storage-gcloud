git config --global user.email "luisnoejasso@gmail.com"
...
Then set environment variables before starting your application:
    ...
    export GOOGLE_CLOUD_PROJECT=gaetrain.appspot.com
    export GCLOUD_STORAGE_BUCKET=trainbuckets
    export GCLOUD_STORAGE_BUCKET=<your-bucket-name>  trainbuckets
    npm install
    npm start
